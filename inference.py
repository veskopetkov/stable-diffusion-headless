...
def main():
    ...
    payload = {
        "prompt": opt.prompt,
        "negative_prompt": "(hands: 1.7), (fingers: 1.4), (feet: 1.3), child, childlike, (monochrome:1.3), (oversaturated:1.3), 3d render, cartoon, ((blurry)), logo, signature, text, words, artifacts, kid, ugly teeth, blurry teeth",
        "seed": 1234,
        "steps": 35,
        "width": opt.w,
        "height": opt.h,
